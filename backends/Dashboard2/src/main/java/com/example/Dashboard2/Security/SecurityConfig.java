...
public class SecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/properties/**","/api/tenant-groups/**","/api/agreements/**","/api/payment_mode/**"
                                ...
                                ,"/api/po_itemNames/**","/api/po_type/**","/api/purchase_orders/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000", "https://dashboard.aabuilders.in")); // ✅ specific origins
